...
export default function ReviewPage() {
  ...
  // Also load the community for member count and CTA
  const communitySlug = (page?.frontmatter as Record<string, unknown> | undefined)?.community_slug as string | undefined ?? slug;
    ...
    return (
      <SiteLayout>
        <div className="container py-24 text-center">
          ...
          <p className="mt-2 text-muted-foreground">This review doesn't exist.</p>
        ...
        <article className="mt-6">
          <header>
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              <span className="rounded-[2px] bg-secondary px-2 py-0.5 font-medium">Review</span>
              {page.wordCount && (
