---
title: "Digital Brand Builders Review 2026: Jamal's E-Commerce Coaching Community"
...
- Free to join, despite the community positioning itself around a large, headline sales figure.
- A named individual associated with the results claimed, rather than an anonymous brand.
- Specific platforms named (Amazon and Shopify) rather than a vague "e-commerce" pitch.

## Cons

- The $20 million figure is a self-reported claim in the community's own description and hasn't been independently verified here.
- No curriculum details, format, or specific e-commerce strategy (private label, wholesale, dropshipping) are named.
...
Sellers who want fully independently verified results before committing time to a coaching community, or anyone looking for one specific e-commerce model, like wholesale only or dropshipping only, not confirmed in the description, may want to ask for more detail first.

[See Digital Brand Builders's real growth data on TrustSkool](https://trustskool.com/community/strategic-fba)
